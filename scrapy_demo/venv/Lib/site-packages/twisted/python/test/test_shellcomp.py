...
class SimpleProgOptions(usage.Options):
    ...
    """
    optFlags = [['color', 'a', 'Turn on color output'],
...
'(--color --gray -g)-a[Color on]' \\
'(--gray -a -g)--color[Color on]' \\
'(--color --gray -a)-g[Turn on gray-scale output]' \\
'(--color -a -g)--gray[Turn on gray-scale output]' \\
