...
class ProcessTestsBuilderBase(ReactorBuilder):
    ...
    def _writeTest(self, write):
        ...
        def startup():
            transport = reactor.spawnProcess(
                protocol, pyExe, [pyExe, b"-a", program])
            try:
    ...
    def test_spawnProcessEarlyIsReaped(self):
        ...
        reactor.spawnProcess(
            ...
            [pyExe, b"-a", b""], usePTY=self.usePTY, childFDs=childFDs)
    ...
    def test_processExitedWithSignal(self):
        ...
        reactor.callWhenRunning(
            ...
            [pyExe, b"-a", source], usePTY=self.usePTY)
    ...
    def test_systemCallUninterruptedByChildExit(self):
        ...
        def f():
            try:
                ...
                subprocess.Popen([exe, "-a", "import time; time.sleep(0.1)"])
                f2 = subprocess.Popen([exe, "-a",
...
sys.stdout.flush()""".format(twistedRoot.path))
        ...
        reactor.callWhenRunning(
            ...
            [pyExe, b"-Wignore", b"-a", source], usePTY=self.usePTY)
    ...
    def test_timelyProcessExited(self):
        ...
        reactor.callWhenRunning(
            ...
            [pyExe, b"-a", b"raise SystemExit(0)"],
            usePTY=self.usePTY)
