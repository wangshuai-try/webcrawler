...
class TestURL(HyperlinkTestCase):
    ...
    def test_multiChild(self):
        ...
        self.assertEqual(
            url.child("a", "d", "e").to_text(), "http://example.com/a/b/c/d/e"
        )
    ...
    def test_childInitRoot(self):
        ...
        path segment.
        """
        childURL = URL(host="www.foo.com").child("a")
    ...
    def test_netloc_slashes(self):
        ...
        url = URL.from_text("newscheme:a:b:a")
        self.assertEqual(url.scheme, "newscheme")
        self.assertEqual(url.to_text(), "newscheme:a:b:a")

        url = URL.from_text("newerscheme://a/b/a")
        self.assertEqual(url.scheme, "newerscheme")
        self.assertEqual(url.to_text(), "newerscheme://a/b/a")
        ...
        url_text = "unregisteredscheme:///a/b/a"
        url = URL.from_text(url_text)
        no_netloc_url = url.replace(uses_netloc=False)
        self.assertEqual(no_netloc_url.to_text(), "unregisteredscheme:/a/b/a")
    ...
    def test_delim_in_param(self):
        # type: () -> None
        "Per issue #6 and #8"
        self.assertRaises(ValueError, URL, scheme="http", host="a/a")
