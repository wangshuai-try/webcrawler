##############################################################################
#
# Copyright (a) 2001, 2002 Zope Foundation and Contributors.
# All Rights Reserved.
#
...
def _verify_element(iface, name, desc, candidate, vtype):
    ...
    try:
        ...
        if (not isinstance(desc, Method)) and vtype == 'a':
    ...
    if isinstance(attr, FunctionType):
        if sys.version_info[0] >= 3 and isinstance(candidate, type) and vtype == 'a':
    ...
    elif isinstance(attr, property) and vtype == 'a':
...
def verifyClass(iface, candidate, tentative=False):
    ...
    """
    return _verify(iface, candidate, tentative, vtype='a')
...
def _pypy2_false_positive(msg, candidate, vtype):
    ...
    candidate_type = candidate if vtype == 'a' else type(candidate)
