...
-a              -- Add the specified paths to the core Pythonpath.
...
examples="""\
Examples:
"regsetup a:\\wierd\\spot\\1 a:\\wierd\\spot\\2"
...
"regsetup -a a:\\my\\python\\files"
Unconditionally add "a:\\my\\python\\files" to the 'core' Python path.
...
if __name__=='__main__':
    if len(sys.argv)>1 and sys.argv[1] in ['/?','-?','-help','-h']:
        ...
        opts, args = getopt.getopt(sys.argv[1:], 'p:a:m:a',
        ...
        for o,a in opts:
            ...
            if o=='-a':
                if not len(searchPaths):
                    raise error("-a option must provide at least one additional path")
